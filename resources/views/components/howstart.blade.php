        ...
        <div class="grid lg:gap-x-12 lg:grid-cols-3">
            <div class="mb-12 lg:mb-0">
                <div class="rounded-lg shadow-lg h-full block bg-white">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-blue-600 mb-4">注册账户</h3>
                   
                        <p class="text-gray-500">
                            如果您还没有注册系统账户，应该先注册一个账户
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-12 lg:mb-0">
                <div class="rounded-lg shadow-lg h-full block bg-white">
                    <div class="flex justify-center">
                        <div class="p-4 bg-blue-600 rounded-full shadow-lg inline-block -mt-8">
                        <svg class="w-7 h-7 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-blue-600 mb-4">创建订单</h3>
            ...
            <div class="">
                <div class="rounded-lg shadow-lg h-full block bg-white">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-blue-600 mb-4">即时查看</h3>

...
<section class="mb-10 text-gray-800 text-center lg:text-left">
    <div class="block rounded-lg shadow-lg bg-gray-100">
        <div class="flex flex-wrap items-center">
            <div class="grow-0 px-6  py-6 shrink-0 basis-auto block lg:flex w-full lg:w-6/12 xl:w-4/12">
            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                <div class="px-6 py-12 md:px-12">
                    ...
                    <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-white dark:bg-white text-blue-600 dark:text-white" data-inactive-classes="bg-gray-100">
                            ...
                            justify-between
                             w-full
                              ...
                              text-gray-500
                               border
                                border-b-0 
                                border-gray-200 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 " data-accordion-target="#accordion-color-body-1" aria-expanded="true" aria-controls="accordion-color-body-1">
                        ...
                        <div id="accordion-color-body-1" class="" aria-labelledby="accordion-color-heading-1">
                            <div class="p-5 font-light border border-b-0 border-white dark:border-white dark:bg-white">

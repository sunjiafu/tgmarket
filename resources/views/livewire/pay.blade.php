...
<div class="flex flex-row min-h-screen  text-gray-800">
        ...
        <main class="main flex flex-col  w-full -ml-64 md:ml-0 transition-all duration-150 ease-in">
                ...
                <div class="main-content flex flex-col flex-grow p-4">
                        <h1 class="font-bold text-2xl text-gray-700">充值</h1>
                                                ...
                                                <div id="alert-1" class="flex p-4 mb-4 bg-blue-100 rounded-lg dark:bg-blue-200" role="alert">
                                                        ...
                                                        <div class="ml-3 text-sm font-medium text-blue-700 dark:text-blue-800">
                                                                <ul class="mt-1.5 ml-4 list-disc list-inside">
                                                                        <li class="mt-5">手动充值:<a href="#" class="font-semibold underline"> 点击联系TG支持</a></li>
                                                                        <li class="mt-5">请准确填写您的Telegram关联链接地址。</li>
                                                                        <li class="mt-5">付款金额要与付款页面出现的金额保持一致，否则无法自动完成</li>
                                                                </ul>
                                                        </div>
